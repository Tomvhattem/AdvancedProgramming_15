...
file_name_2 = 'tested_molecules_v2.csv'
...
def filter_df(file_name,file_name_2):
    df_molecules = pd.read_csv(file_name)
    df_molecules_2 = pd.read_csv(file_name_2)
    df_molecules = pd.concat([df_molecules,df_molecules_2])
...
df_data = filter_df(file_name,file_name_2)
...
df_loadings = pd.DataFrame(variable_loadings, columns=df_data.columns)
